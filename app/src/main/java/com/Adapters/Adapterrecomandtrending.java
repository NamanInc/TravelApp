...
public class Adapterrecomandtrending extends RecyclerView.Adapter<Adapterrecomandtrending.MyHolder>{
    ...
    public Adapterrecomandtrending(Context context, List<ModelPost> postList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.trendingvertical,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.ratingBar.setRating(Float.parseFloat(postList.get(position).getRating()));
