...
public class TravelPostAdapter extends RecyclerView.Adapter<TravelPostAdapter.MyHolder>{
    ...
    public TravelPostAdapter(Context context, List<ModelPostgram> postList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.travelgrampost,parent,false);
...
//        holder.username.setText(usernametxt);
        ...
        getPublisherInfo(holder.profileImage,holder.tick,holder.username,postList.get(position).getUid());
...
//    }
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            tick = itemView.findViewById(R.id.ticktravel);
