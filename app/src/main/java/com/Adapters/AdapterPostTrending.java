...
public class AdapterPostTrending extends RecyclerView.Adapter<AdapterPostTrending.MyHolder>{
    ...
    public AdapterPostTrending(Context context, List<ModelPost> postList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.trendingcards,parent,false);
