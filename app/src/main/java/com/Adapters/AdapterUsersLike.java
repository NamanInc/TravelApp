...
public class AdapterUsersLike extends RecyclerView.Adapter<AdapterUsersLike.MyHolder> {

    Context context;
    List<ModelUsers> usersList;


    public AdapterUsersLike(Context context, List<ModelUsers> usersList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.likeuser,parent,false);
