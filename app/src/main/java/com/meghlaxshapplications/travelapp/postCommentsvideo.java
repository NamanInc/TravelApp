...
public class postCommentsvideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentAdapter = new Comment_adapter(postCommentsvideo.this,commentModelList);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addcomment.getText().toString().equals("")){
                    ...
                    Toast.makeText(postCommentsvideo.this, "Please write a Comment", Toast.LENGTH_SHORT).show();
    ...
    private void addComment() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("PostCommentsVideo").child(postId);
